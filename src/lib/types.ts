...
// the real tx ids. This is how Activity gets a TRUE inbound tx id the moment
// funds hit the mempool, ahead of confirmation. `received`/`spent` default to
// empty server-side, so treat them as optional.
...
// local broadcast log, this surfaces deposits that landed while the app was
